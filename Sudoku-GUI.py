...
import pygame
import time
from randomizeBoard import sudokuBoard as sb
...
def redraw_window(win, board, time, strikes):
    # Change window fill to black
    win.fill((0, 0, 0))
    # Draw time
    fnt = pygame.font.SysFont("comicsans", 40)
    text = fnt.render("Time: " + format_time(time), 1, (255, 255, 255))
    # Shift the time to the side
    win.blit(text, (540 - 180, 560))
    # Draw Strikes when wrong number is inserted
